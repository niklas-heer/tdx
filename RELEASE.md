...
The tag workflow checks the version, builds five platform binaries with Dagger, uses the reviewed release notes (or generates notes when none exist), creates the GitHub release, and updates the Homebrew tap. The application and Dagger module use the compatible toolchains documented in README.md.
