...
- FROM: `### Requirement: Bun-based TypeScript CLI entry point`
- TO: `### Requirement: Go CLI entry point`
- FROM: `### Requirement: Minimal custom markdown parser and writer`
- TO: `### Requirement: AST-based Markdown parser and writer`
