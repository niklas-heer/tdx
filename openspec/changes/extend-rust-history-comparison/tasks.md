## 1. Scope
- [x] 1.1 Record the user's continuation authorization and review the next milestone against the existing report and specs.
- [x] 1.2 Validate the proposal and delta.

## 2. Implementation and evaluation
- [x] 2.1 Implement compatible history, configuration and persistence error semantics with regressions.
